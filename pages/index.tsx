        ...
        <div className="ml-6">
          ...
          <ul className="flex text-zinc-600">
            <li className="border-4 border-zinc-500 p-2 flex justify-center items-center">
              ...
              <a
                className="hover:text-zinc-900 hover:underline ml-2"
                target="_blank"
                href="
              https://www.linkedin.com/in/altanaldeniz/"
              >
                LinkedIn
              </a>
            </li>
            <li className="ml-2 p-2 border-4 border-zinc-500 flex justify-center items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
              ...
              <a
                className="hover:text-zinc-900 hover:underline ml-2"
                target="_blank"
                href="https://www.twitter.com/altanaldeniz/"
              >
                Twitter
              </a>
            </li>
            <li className="ml-2 p-2 border-4 border-zinc-500  flex justify-center items-center">
              ...
              <a
                className="hover:text-zinc-900 hover:underline ml-2"
                target="_blank"
                href="https://www.github.com/altanaldeniz/"
              >
                GitHub
              </a>
            </li>
